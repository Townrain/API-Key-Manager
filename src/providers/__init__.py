...
PROVIDER_ERROR_SIGNATURES: dict[str, list[str]] = {
    # Providers with unique identifiers in error body
    "dashscope": ["aliyun", "model-studio", "modelstudio", "dashscope", "apikey-error", "invalid_api_key", "incorrect api key", "invalid_request_error"],
    "dashscope-coding": ["dashscope", "modelstudio"],
    "cerebras": ["cerebras"],
    "tencent-hunyuan": ["hunyuan", "tencent"],
    "baichuan": ["baichuan-ai.com", "baichuan"],
    ...
    # Providers with provider name in error body
    "anthropic": ["anthropic", "x-api-key", "authentication_error"],
    ...
    "doubao": ["doubao", "volcengine", "bytedance", "authenticationerror"],
    "infini": ["infini", "infini-ai"],
    "nvidia": ["nvidia", "nim.api"],
    "hyperbolic": ["hyperbolic", "could not validate credentials"],
    "poe": ["poe.com"],
    "modelscope": ["modelscope"],
    "mimo": ["xiaomimimo", "mimo"],
    "mimo-plan": ["xiaomimimo", "mimo"],
    "zai": ["zhipu", "token expired or incorrect"],
    "ai302": ["302.ai"],
    "ppio": ["ppio"],
    "cstcloud": ["cstcloud", "zhongsuanyun"],
    "longcat": ["longcat"],
    "zhipu-coding": ["bigmodel", "zhipu"],
    "kimi-coding": ["kimi"],
    "infini-coding": ["infini", "infini-ai"],
    # OpenAI-compatible providers (generic signatures)
