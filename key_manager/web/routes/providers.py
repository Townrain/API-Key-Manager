...
async def api_providers_create(request: Request):
    ...
    from key_manager.providers.config_providers import _create_provider_from_config, save_custom_provider
    ...
    try:
        ...
        raise ValidationError(code=ErrorCode.VALIDATION_INVALID_FORMAT,
                            message=f"Failed to create provider: {str(e)}") from e
...
async def api_providers_update(provider_name: str, request: Request):
    ...
    try:
        ...
        raise ValidationError(code=ErrorCode.VALIDATION_INVALID_FORMAT,
                            message=f"Failed to update provider: {str(e)}") from e
...
async def api_providers_delete(provider_name: str):
    ...
    try:
        ...
        raise ValidationError(code=ErrorCode.VALIDATION_INVALID_FORMAT,
                            message=f"Failed to delete provider: {str(e)}") from e
